...
//        Network network = new Network(784, 45, 25, 10);
//        TrainSet set = createTrainSet(0,4999);
//        trainData(network, set, 1000, 100, 100, "res/mnist4.txt");

//        TrainSet testSet = createTrainSet(5000,9999);
//        testTrainSet(network, testSet, 10);

        try{
            Network net = Network.loadNetwork("res/mnist4.txt");
            testTrainSet(net, createTrainSet(0, 4999), 10);
        } catch(Exception e){
            e.printStackTrace();
        }
    }
